 ...
 * Seçiciler genel tutuldu: #intro, .intro, [data-intro], .splash, .preloader, [data-splash]
 */
...
export default function IntroOnce() {
  React.useEffect(() => {
    try {
      const seen = typeof window !== "undefined" && window.localStorage?.getItem("intro_seen") === "1";
      if (seen) {
